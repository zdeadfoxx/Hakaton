                          ...
                          <div class="main__info my__orders">
                            <div class="main__text-info">
                              ...
                              <div class="main__text_info">
                               <form action="">
                                <div class="promo">
                                    <h3 class="promotional main__title-info"> Название заказа</h3>
                                   </div>
                                     <div class="promotional__text ">
                                        <textarea class="form-control order__area" id="exampleFormControlTextarea1" rows="6" placeholder="Краткое описание"></textarea>
                                     </div>
                                     <div class="promo__price">
                                        <Span> Цена:  <p>  от <input type="text" class="oreder__input"> до  <input type="text" class="oreder__input"></p></Span>
                                     </div>
                                     <div class="promo__price sroki">
                                        <Span> Сроки:  <p>   <input type="text" class="oreder__input"></p></Span>
                                     </div>
                                     <div class="promo__price place">
                                        <Span> Место оказание услуги:  <p>   <input type="text" class="oreder__input"></p></Span>
                                        <p class="orders__infote">
                                            Если задачу можно выполнитьдистанционно, то адрес писать не надо
                                        </p>
                                     </div>
                                    <div class="buttonssss">
                                        <button class="applications__buttons hover orders__butons">Сохранить</button>
                                    </div>
                               </form>
                              </div>
                          </div>
                            ...
                            <div class="main__text-info">
                                <form action="">
                                    <div class="main__title_proffiledit contact__title">
                                        <h2 class="main__title-info concat__title1">Связаться со мной</h2>
