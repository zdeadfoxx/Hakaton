            ...
            <div class="card card__register">
                ...
                <div class="card-body">
                    ...
                    @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control input @error('name') is-invalid @enderror" name="name"   autocomplete="name" placeholder="Имя*">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <input id="LastName" type="text" class="form-control input @error('LastName') is-invalid @enderror" name="lastname"  autocomplete="LastName" placeholder="Отчество">
